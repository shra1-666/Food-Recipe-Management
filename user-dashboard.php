...
$sql = sprintf("SELECT * FROM recipe
                WHERE recipe_id IN(SELECT recipe_id FROM saved_recipe WHERE user_id='$user_id')");
            ...
            <div class="chef-dash-content-div">
                ...
                <div class="recipe-list-body chef-recipe-list-body">
                    <?php
                        ...
                        {
                            $redir_url='add-review.php?recipe_id=' . urlencode($row["recipe_id"]);
                    ?>
                    <div class="recipe-list-content">
                        ...
                        <div class="save-icon-div add-rev-dash-btn-div">
                            <a class="add-rev-btn-dash" href="<?php echo $redir_url; ?>">Add review</a>
                        </div>
                    </div>
                    <?php
                        }
